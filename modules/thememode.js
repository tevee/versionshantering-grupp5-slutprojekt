export const handleDarkMode = {
	...
	change: (event) => {
		...
		if (darkMode) {
			document.documentElement.style.setProperty("--headerAndFooter-color", "#000000");
			...
			document.documentElement.style.setProperty("--like-btn-border-color", "#ffffff");
			document.documentElement.style.setProperty("--like-btn-hover-color", "#808080");
		} 
		else {
            document.documentElement.style.setProperty("--headerAndFooter-color", "#ffffff");
			...
			document.documentElement.style.setProperty("--like-btn-color", "#ffffff");
